...
- Разница между гильбертом и настоящей формой импульса авторы объясняют тем, что гильберт недостаточно точно описывает форму импульса, что приводит к смещению, который только увеличивается с ростом расстояния от оси ливня. Т.е. это не связано с неправильным лоцированием.
-
-
