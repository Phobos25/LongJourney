...
- Epochs
	- Это полный цикл обучения нейросети на входных данных.
		- для малого количество данных (<10 000) надо 10-50
		- для среднего (<100 000) надо 50-200
		- для больших 100-500
	- если количество циклов будет недостаточно большим, то модель не сможет обучиться.
	- если будет слишком большим, то модель переобучиться (overfitting)
- ### Что такое нейросеть
  collapsed:: true
