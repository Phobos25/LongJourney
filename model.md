...
//TODO 1) Сделана конвертация с СК 1 в СК 2, для двух случаев
//TODO 2) В СК 1 они были одинаковые, в СК 2 существенно отличаются.
//TODO 3) Конвертация с СК 1 на СК 2 **дома** не сработала. Координаты должны были лежать на прямой, максимум с небольшим отклонением, т.к. есть ошибка округления у питона.
//TODO надо посмотреть координаты, может они не так сильно отличаются? потому что возможны небольшие ошибки. 
20210610
