...
# Advanced Pipeline
че то не получаетс€, выдает ошибку, надо с самого начала пройтись. ј то € за мес€ц все забыл. «автра пошагово пройду, 
что € хочу сделать, как сделать и т.п. 

вроде вспомнил. », кажетс€, пон€л. Ќадо указывать в pipeline.fit дл€ конкретной модели. что-то типа xgboost.early_stopping_rounds = 5. 