...
public:
  ...
  string GetFullNameWithHistory(int year) {
    const vector<string> all_first_names = FindPersonAllNamesAtYear(year, first_names_);
    const vector<string> all_last_names  = FindPersonAllNamesAtYear(year, last_names_);
